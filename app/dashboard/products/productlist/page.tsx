...
const AddProduct = dynamic(() => import('../addproduct/page'), {ssr: false});
...
const ResponsiveTable: React.FC = () => {
  ...
  <input
    ...
    className="dark:bg-[#22262c] border-gray-300 border rounded-md px-4 py-2 text-sm focus:outline-none focus:border-blue-500 w-full sm:w-64"
  />
    ...
    <div className="max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto p-4">
      <div className="overflow-x-auto w-full">
        <table className="min-w-full bg-white border border-gray-200 dark:bg-[#292e37]">
          <thead>
            <tr className="border dark:text-[#FFFFFFCC] bg-gray-200 text-gray-600 text-left text-sm leading-normal dark:bg-[#292e37]">
